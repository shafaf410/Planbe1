...
export default function About() {
  ...
  return (
    <section className="w-full font-sans text-[#111111] overflow-hidden bg-transparent">
      ...
      <section className="w-full py-24 md:py-40 px-4 sm:px-6 md:px-12 bg-transparent">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-start">
          <motion.div 
            initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
            className="w-full aspect-square md:aspect-[4/5] bg-[#EAE8E4] relative overflow-hidden lg:sticky lg:top-24"
          >
            <Image 
