...
import { HTMLMotionProps, Transition, motion, useInView } from "framer-motion"
import { cn } from "@/lib/utils"

const easeTransitions = {
  default: [0.25, 0.1, 0.25, 1] as [number, number, number, number],
  transform: [0.42, 0, 0.58, 1] as [number, number, number, number], 
  opacity: [0.25, 0.1, 0.25, 1] as [number, number, number, number], 
  clipPath: [0.6, 0.04, 0.98, 0.335] as [number, number, number, number], 
}
